...
function ChatPage() {
  ...
  return (
    <div className="w-full h-screen bg-[#ECE5DD] dark:bg-slate-900 flex flex-col overflow-hidden">
      ...
      <div className="md:hidden bg-cyan-700 dark:bg-cyan-700 border-b border-[#075E54] dark:border-slate-700 px-4 py-3 flex items-center gap-3">
        <div className="flex items-center gap-2 flex-1">
          ...
          <h1 className="text-lg font-bold text-white">Family Chat</h1>
        </div>
      </div>
